<template>
    <div class="post">
        ...
        <div v-if="component" class="content">
            <h2>{{component.spec.type}} component
                ({{component.metadata.name}})</h2>
                ...
                <div class="card" style="width: 18rem;"
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted">
                            {{service.spec.type}}</h6>
                        <p v-for="port in service.spec.ports" class="card-text">
            ...
            <div class="card-deck">
                <div class="card" style="width: 18rem;"
                     v-for="statefulset in statefulsets">
                    <div class="card-body">
                        <h5 class="card-title">
                            {{statefulset.metadata.name}}</h5>
                    </div>
                </div>
            </div>
            <h3>Configs</h3>
            ...
            <div class="card-deck">
                <div class="card"
                     style="min-width: 18rem; max-width: 18rem; margin: 1em;"
                     v-for="pod in pods">
                    <div class="card-body">
