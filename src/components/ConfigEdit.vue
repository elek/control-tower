  ...
  data () {
   ...
   submit() {
      ...
      // eslint-disable-next-line
       this.$http.put("/api/v1/namespaces/" + this.$store.state.namespace + "/configmaps/" + this.$route.params.name, obj).then(post => {
   ...
   fetchData () {
       this.$http.get("/api/v1/namespaces/" + this.$store.state.namespace + "/configmaps/" + this.$route.params.name).then(post => {
